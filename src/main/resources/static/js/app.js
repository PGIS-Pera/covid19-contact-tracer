$(document).ready(function () {
    ...
    //remove inspect anf key option on web page
    //disableInspectElementAndKeyCombinationOnWebBrowser();
...
function disableInspectElementAndKeyCombinationOnWebBrowser() {
